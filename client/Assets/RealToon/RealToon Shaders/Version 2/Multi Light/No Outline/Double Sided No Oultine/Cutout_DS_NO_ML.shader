...
////// Emissive:
                ...
                float node_6016 = (_HardEdgeFresnel_var*lerp(0.0,_HardEdgeFresnel_var,(lerp( node_3706, node_9545, _FresnelOnLight )*lerp( node_3706, node_6054, _FresnelOnShadow ))));
                ...
                float3 node_6360 = lerp(float3(node_8036,node_8036,node_8036),lerp(lerp(float3(node_8469,node_8469,node_8469),(_Texture_var.rgb*0.9),_MainTextureColorAO),float3(node_2902,node_2902,node_2902),lerp(_AOTexture_var.rgb,dot(_AOTexture_var.rgb,float3(0.3,0.59,0.11)),1.0)),lerp(0.0,lerp(1.0,10.0,_MainTextureColorAO),_AOIntensity));
                ...
                float node_750 = 0.0;
                float3 finalColor = emissive + lerp(saturate(min((((lerp(node_3766,(node_3766*(lerp(float3(node_9545,node_9545,node_9545),lerp(lerp((node_6054*_SelfShadowColor.rgb),lerp(float3(node_5129,node_5129,node_5129),saturate((1.0-((1.0-0.44)/_Texture_var.rgb))),node_6054),_MainTextureColorSelfShadow),lerp((lerp(float3(node_557,node_557,node_557),_SelfShadowPTexture_var.rgb,_SelfShadowPTexture_var.a)*0.54),float3(node_3933,node_3933,node_3933),node_9545),_SelfShadowPTextureIntensity),0.65)*2.86)),lerp(0.0,lerp(1.0,2.6,_MainTextureColorSelfShadow),_SelfShadowIntensity))*lerp( lerp(node_6360,float3(node_9073,node_9073,node_9073),node_9545), node_6360, _ShowAOonLight ))+(lerp(float3(node_8914,node_8914,node_8914),lerp(float3(_SoftGloss_var,_SoftGloss_var,_SoftGloss_var),(_SoftGloss_var*_GlossColor.rgb),2.22),_GlossMask_var.rgb)*lerp((node_8388_if_leA*node_2583)+(node_8388_if_leB*_GlossIntensity),_GlossIntensity,node_8388_if_leA*node_8388_if_leB))+lerp(node_137,float3(node_750,node_750,node_750),_FresnelVisibleOnDarkAmbientLight))*(_LightColor0.rgb*lerp( step(0.001,attenuation), attenuation, _EnableLightFalloff ))),node_5038)),dot(saturate(min((((lerp(node_3766,(node_3766*(lerp(float3(node_9545,node_9545,node_9545),lerp(lerp((node_6054*_SelfShadowColor.rgb),lerp(float3(node_5129,node_5129,node_5129),saturate((1.0-((1.0-0.44)/_Texture_var.rgb))),node_6054),_MainTextureColorSelfShadow),lerp((lerp(float3(node_557,node_557,node_557),_SelfShadowPTexture_var.rgb,_SelfShadowPTexture_var.a)*0.54),float3(node_3933,node_3933,node_3933),node_9545),_SelfShadowPTextureIntensity),0.65)*2.86)),lerp(0.0,lerp(1.0,2.6,_MainTextureColorSelfShadow),_SelfShadowIntensity))*lerp( lerp(node_6360,float3(node_9073,node_9073,node_9073),node_9545), node_6360, _ShowAOonLight ))+(lerp(float3(node_8914,node_8914,node_8914),lerp(float3(_SoftGloss_var,_SoftGloss_var,_SoftGloss_var),(_SoftGloss_var*_GlossColor.rgb),2.22),_GlossMask_var.rgb)*lerp((node_8388_if_leA*node_2583)+(node_8388_if_leB*_GlossIntensity),_GlossIntensity,node_8388_if_leA*node_8388_if_leB))+lerp(node_137,float3(node_750,node_750,node_750),_FresnelVisibleOnDarkAmbientLight))*(_LightColor0.rgb*lerp( step(0.001,attenuation), attenuation, _EnableLightFalloff ))),node_5038)),float3(0.3,0.59,0.11)),node_3161);
...
////// Lighting:
                ...
                float node_5038 = (1.0 - _ReduceWhite);
                float node_3161 = (1.0 - _Saturation);
                float3 finalColor = lerp(saturate(min((((lerp(node_3766,(node_3766*(lerp(float3(node_9545,node_9545,node_9545),lerp(lerp((node_6054*_SelfShadowColor.rgb),lerp(float3(node_5129,node_5129,node_5129),saturate((1.0-((1.0-0.44)/_Texture_var.rgb))),node_6054),_MainTextureColorSelfShadow),lerp((lerp(float3(node_557,node_557,node_557),_SelfShadowPTexture_var.rgb,_SelfShadowPTexture_var.a)*0.54),float3(node_3933,node_3933,node_3933),node_9545),_SelfShadowPTextureIntensity),0.65)*2.86)),lerp(0.0,lerp(1.0,2.6,_MainTextureColorSelfShadow),_SelfShadowIntensity))*lerp( lerp(node_6360,float3(node_9073,node_9073,node_9073),node_9545), node_6360, _ShowAOonLight ))+(lerp(float3(node_8914,node_8914,node_8914),lerp(float3(_SoftGloss_var,_SoftGloss_var,_SoftGloss_var),(_SoftGloss_var*_GlossColor.rgb),2.22),_GlossMask_var.rgb)*lerp((node_8388_if_leA*node_2583)+(node_8388_if_leB*_GlossIntensity),_GlossIntensity,node_8388_if_leA*node_8388_if_leB))+lerp(node_137,float3(node_750,node_750,node_750),_FresnelVisibleOnDarkAmbientLight))*(_LightColor0.rgb*lerp( step(0.001,attenuation), attenuation, _EnableLightFalloff ))),node_5038)),dot(saturate(min((((lerp(node_3766,(node_3766*(lerp(float3(node_9545,node_9545,node_9545),lerp(lerp((node_6054*_SelfShadowColor.rgb),lerp(float3(node_5129,node_5129,node_5129),saturate((1.0-((1.0-0.44)/_Texture_var.rgb))),node_6054),_MainTextureColorSelfShadow),lerp((lerp(float3(node_557,node_557,node_557),_SelfShadowPTexture_var.rgb,_SelfShadowPTexture_var.a)*0.54),float3(node_3933,node_3933,node_3933),node_9545),_SelfShadowPTextureIntensity),0.65)*2.86)),lerp(0.0,lerp(1.0,2.6,_MainTextureColorSelfShadow),_SelfShadowIntensity))*lerp( lerp(node_6360,float3(node_9073,node_9073,node_9073),node_9545), node_6360, _ShowAOonLight ))+(lerp(float3(node_8914,node_8914,node_8914),lerp(float3(_SoftGloss_var,_SoftGloss_var,_SoftGloss_var),(_SoftGloss_var*_GlossColor.rgb),2.22),_GlossMask_var.rgb)*lerp((node_8388_if_leA*node_2583)+(node_8388_if_leB*_GlossIntensity),_GlossIntensity,node_8388_if_leA*node_8388_if_leB))+lerp(node_137,float3(node_750,node_750,node_750),_FresnelVisibleOnDarkAmbientLight))*(_LightColor0.rgb*lerp( step(0.001,attenuation), attenuation, _EnableLightFalloff ))),node_5038)),float3(0.3,0.59,0.11)),node_3161);
