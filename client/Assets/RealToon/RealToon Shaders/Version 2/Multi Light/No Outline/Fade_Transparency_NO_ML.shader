...
////// Emissive:
                ...
                float node_4087 = lerp(0.0,_HardEdgeFresnel_var,(lerp( node_3073, node_9545, _FresnelOnLight )*lerp( node_3073, node_6054, _FresnelOnShadow )));
                float node_8684 = (_HardEdgeFresnel_var*node_4087);
                ...
                float3 node_6887 = lerp(float3(node_650,node_650,node_650),lerp(lerp(float3(node_9549,node_9549,node_9549),(_Texture_var.rgb*0.9),_MainTextureColorAO),float3(node_9330,node_9330,node_9330),lerp(_AOTexture_var.rgb,dot(_AOTexture_var.rgb,float3(0.3,0.59,0.11)),1.0)),lerp(0.0,lerp(1.0,10.0,_MainTextureColorAO),_AOIntensity));
