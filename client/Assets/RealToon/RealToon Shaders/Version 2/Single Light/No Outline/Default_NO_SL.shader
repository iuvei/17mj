...
////// Emissive:
                ...
                float node_4087 = lerp(0.0,_HardEdgeFresnel_var,(lerp( node_9853, node_5147, _FresnelOnLight )*lerp( node_9853, (1.0 - node_5147), _FresnelOnShadow )));
                float node_7879 = (_HardEdgeFresnel_var*node_4087);
                float3 node_137 = ((node_7879*_FresnelColor.rgb)*_FresnelIntensity);
                float3 node_456 = (0.0*node_137);
                float3 node_9195 = ((node_7879*_FresnelColor.rgb)*_FresnelIntensity);
                ...
                float node_7732 = 1.0;
                float node_695 = 0.0;
                float3 node_1752 = lerp(float3(node_695,node_695,node_695),(_Texture_var.rgb*0.9),_MainTextureColorAO);
                float node_132 = 1.0;
                ...
                float node_9574 = 0.0;
                float3 finalColor = emissive + lerp(saturate(min(((((node_3766*(lerp(float3(node_5741,node_5741,node_5741),lerp(lerp((node_6054*_ShadowColor.rgb),lerp(float3(node_4914,node_4914,node_4914),saturate((1.0-((1.0-0.44)/_Texture_var.rgb))),node_6054),_MainTextureColorShadow),lerp(float3(node_653,node_653,node_653),(lerp(lerp(float3(node_557,node_557,node_557),_ShadowPTexture_var.rgb,_ShadowPTexture_var.a),float3(node_3933,node_3933,node_3933),node_2605)*lerp(0.54,1.65,_MainTextureColorShadow)),_ShadowIntensity),_ShadowPTextureIntensity),0.65)*2.86))*lerp( lerp(node_5158,float3(node_7654,node_7654,node_7654),node_2605), node_5158, _ShowAOonLight ))+(lerp(float3(node_6011,node_6011,node_6011),lerp(float3(_SoftGloss_var,_SoftGloss_var,_SoftGloss_var),(_SoftGloss_var*_GlossColor.rgb),2.22),_GlossMask_var.rgb)*lerp((node_8388_if_leA*node_2583)+(node_8388_if_leB*_GlossIntensity),_GlossIntensity,node_8388_if_leA*node_8388_if_leB))+lerp(node_137,float3(node_9574,node_9574,node_9574),_FresnelVisibleOnDarkAmbientLight))*_LightColor0.rgb),node_5038)),dot(saturate(min(((((node_3766*(lerp(float3(node_5741,node_5741,node_5741),lerp(lerp((node_6054*_ShadowColor.rgb),lerp(float3(node_4914,node_4914,node_4914),saturate((1.0-((1.0-0.44)/_Texture_var.rgb))),node_6054),_MainTextureColorShadow),lerp(float3(node_653,node_653,node_653),(lerp(lerp(float3(node_557,node_557,node_557),_ShadowPTexture_var.rgb,_ShadowPTexture_var.a),float3(node_3933,node_3933,node_3933),node_2605)*lerp(0.54,1.65,_MainTextureColorShadow)),_ShadowIntensity),_ShadowPTextureIntensity),0.65)*2.86))*lerp( lerp(node_5158,float3(node_7654,node_7654,node_7654),node_2605), node_5158, _ShowAOonLight ))+(lerp(float3(node_6011,node_6011,node_6011),lerp(float3(_SoftGloss_var,_SoftGloss_var,_SoftGloss_var),(_SoftGloss_var*_GlossColor.rgb),2.22),_GlossMask_var.rgb)*lerp((node_8388_if_leA*node_2583)+(node_8388_if_leB*_GlossIntensity),_GlossIntensity,node_8388_if_leA*node_8388_if_leB))+lerp(node_137,float3(node_9574,node_9574,node_9574),_FresnelVisibleOnDarkAmbientLight))*_LightColor0.rgb),node_5038)),float3(0.3,0.59,0.11)),node_3161);
