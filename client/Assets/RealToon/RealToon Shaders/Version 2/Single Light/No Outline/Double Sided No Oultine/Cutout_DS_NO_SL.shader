...
////// Emissive:
                ...
                float3 node_9195 = ((node_8805*_FresnelColor.rgb)*_FresnelIntensity);
                ...
                float3 node_7583 = lerp(float3(node_7447,node_7447,node_7447),lerp(lerp(float3(node_414,node_414,node_414),(_Texture_var.rgb*0.9),_MainTextureColorAO),float3(node_5864,node_5864,node_5864),lerp(_AOTexture_var.rgb,dot(_AOTexture_var.rgb,float3(0.3,0.59,0.11)),1.0)),lerp(0.0,lerp(1.0,10.0,_MainTextureColorAO),_AOIntensity));
                ...
                float node_4812 = 0.0;
                float3 finalColor = emissive + lerp(saturate(min(((((node_3766*(lerp(float3(node_1657,node_1657,node_1657),lerp(lerp((node_6054*_ShadowColor.rgb),lerp(float3(node_2972,node_2972,node_2972),saturate((1.0-((1.0-0.44)/_Texture_var.rgb))),node_6054),_MainTextureColorShadow),lerp(float3(node_2959,node_2959,node_2959),(lerp(lerp(float3(node_557,node_557,node_557),_ShadowPTexture_var.rgb,_ShadowPTexture_var.a),float3(node_3933,node_3933,node_3933),node_2215)*lerp(0.54,1.65,_MainTextureColorShadow)),_ShadowIntensity),_ShadowPTextureIntensity),0.65)*2.86))*lerp( lerp(node_7583,float3(node_6093,node_6093,node_6093),node_2215), node_7583, _ShowAOonLight ))+(lerp(float3(node_1360,node_1360,node_1360),lerp(float3(_SoftGloss_var,_SoftGloss_var,_SoftGloss_var),(_SoftGloss_var*_GlossColor.rgb),2.22),_GlossMask_var.rgb)*lerp((node_8388_if_leA*node_2583)+(node_8388_if_leB*_GlossIntensity),_GlossIntensity,node_8388_if_leA*node_8388_if_leB))+lerp(node_137,float3(node_4812,node_4812,node_4812),_FresnelVisibleOnDarkAmbientLight))*_LightColor0.rgb),node_5038)),dot(saturate(min(((((node_3766*(lerp(float3(node_1657,node_1657,node_1657),lerp(lerp((node_6054*_ShadowColor.rgb),lerp(float3(node_2972,node_2972,node_2972),saturate((1.0-((1.0-0.44)/_Texture_var.rgb))),node_6054),_MainTextureColorShadow),lerp(float3(node_2959,node_2959,node_2959),(lerp(lerp(float3(node_557,node_557,node_557),_ShadowPTexture_var.rgb,_ShadowPTexture_var.a),float3(node_3933,node_3933,node_3933),node_2215)*lerp(0.54,1.65,_MainTextureColorShadow)),_ShadowIntensity),_ShadowPTextureIntensity),0.65)*2.86))*lerp( lerp(node_7583,float3(node_6093,node_6093,node_6093),node_2215), node_7583, _ShowAOonLight ))+(lerp(float3(node_1360,node_1360,node_1360),lerp(float3(_SoftGloss_var,_SoftGloss_var,_SoftGloss_var),(_SoftGloss_var*_GlossColor.rgb),2.22),_GlossMask_var.rgb)*lerp((node_8388_if_leA*node_2583)+(node_8388_if_leB*_GlossIntensity),_GlossIntensity,node_8388_if_leA*node_8388_if_leB))+lerp(node_137,float3(node_4812,node_4812,node_4812),_FresnelVisibleOnDarkAmbientLight))*_LightColor0.rgb),node_5038)),float3(0.3,0.59,0.11)),node_3161);
