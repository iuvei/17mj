...
////// Emissive:
                ...
                float node_9212 = 1.0;
                float3 _MainTextureColorAO_var = lerp( 0.0, (_Texture_var.rgb*0.9), _MainTextureColorAO );
                float node_3176 = 1.0;
                ...
                float node_3933 = 0.0;
                float3 node_4718 = lerp((lerp(float3(node_557,node_557,node_557),_SelfShadowPTexture_var.rgb,_SelfShadowPTexture_var.a)*0.54),float3(node_3933,node_3933,node_3933),node_9545);
                float node_2997 = 1.0;
                float node_7422 = 0.0;
                ...
                float node_5661 = 0.0;
                float3 finalColor = emissive + lerp(saturate(min((((lerp(node_3766,(node_3766*(lerp(float3(node_9545,node_9545,node_9545),lerp(lerp((node_6054*_SelfShadowColor.rgb),lerp(float3(node_6905,node_6905,node_6905),saturate((1.0-((1.0-0.44)/_Texture_var.rgb))),node_6054),_MainTextureColorSelfShadow),node_4718,_SelfShadowPTextureIntensity),0.65)*2.86)),lerp(0.0,lerp(1.0,2.6,_MainTextureColorSelfShadow),_SelfShadowIntensity))*lerp( lerp(node_2411,float3(node_2997,node_2997,node_2997),node_9545), node_2411, _ShowAOonLight ))+(lerp(float3(node_7422,node_7422,node_7422),lerp(float3(_SoftGloss_var,_SoftGloss_var,_SoftGloss_var),(_SoftGloss_var*_GlossColor.rgb),2.22),_GlossMask_var.rgb)*lerp((node_8388_if_leA*node_2583)+(node_8388_if_leB*_GlossIntensity),_GlossIntensity,node_8388_if_leA*node_8388_if_leB))+lerp(node_137,float3(node_5661,node_5661,node_5661),_FresnelVisibleOnDarkAmbientLight))*_LightColor0.rgb),node_5038)),dot(saturate(min((((lerp(node_3766,(node_3766*(lerp(float3(node_9545,node_9545,node_9545),lerp(lerp((node_6054*_SelfShadowColor.rgb),lerp(float3(node_6905,node_6905,node_6905),saturate((1.0-((1.0-0.44)/_Texture_var.rgb))),node_6054),_MainTextureColorSelfShadow),node_4718,_SelfShadowPTextureIntensity),0.65)*2.86)),lerp(0.0,lerp(1.0,2.6,_MainTextureColorSelfShadow),_SelfShadowIntensity))*lerp( lerp(node_2411,float3(node_2997,node_2997,node_2997),node_9545), node_2411, _ShowAOonLight ))+(lerp(float3(node_7422,node_7422,node_7422),lerp(float3(_SoftGloss_var,_SoftGloss_var,_SoftGloss_var),(_SoftGloss_var*_GlossColor.rgb),2.22),_GlossMask_var.rgb)*lerp((node_8388_if_leA*node_2583)+(node_8388_if_leB*_GlossIntensity),_GlossIntensity,node_8388_if_leA*node_8388_if_leB))+lerp(node_137,float3(node_5661,node_5661,node_5661),_FresnelVisibleOnDarkAmbientLight))*_LightColor0.rgb),node_5038)),float3(0.3,0.59,0.11)),node_3161);
