    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                o.uv0 = v.texcoord0;
                float4 node_6320 = _Time + _TimeEditor;
                float node_5371_ang = node_6320.g;
...
////// Emissive:
                ...
                float node_4087 = lerp(0.0,_HardEdgeFresnel_var,(lerp( node_7969, node_8411, _FresnelOnLight )*lerp( node_7969, (1.0 - node_8411), _FresnelOnShadow )));
                float node_99 = (_HardEdgeFresnel_var*node_4087);
                float3 node_137 = ((node_99*_FresnelColor.rgb)*_FresnelIntensity);
                float3 node_456 = (0.0*node_137);
                float3 node_9195 = ((node_99*_FresnelColor.rgb)*_FresnelIntensity);
                ...
                float3 node_2918 = lerp(float3(node_6873,node_6873,node_6873),lerp(lerp(float3(node_7147,node_7147,node_7147),(_Texture_var.rgb*0.9),_MainTextureColorAO),float3(node_1502,node_1502,node_1502),lerp(_AOTexture_var.rgb,dot(_AOTexture_var.rgb,float3(0.3,0.59,0.11)),1.0)),lerp(0.0,lerp(1.0,10.0,_MainTextureColorAO),_AOIntensity));
                ...
                float node_2761 = 0.0;
                float3 finalColor = emissive + lerp(saturate(min(((((node_3766*(lerp(float3(node_8466,node_8466,node_8466),lerp(lerp((node_6054*_ShadowColor.rgb),lerp(float3(node_6126,node_6126,node_6126),saturate((1.0-((1.0-0.44)/_Texture_var.rgb))),node_6054),_MainTextureColorShadow),lerp(float3(node_6334,node_6334,node_6334),(lerp(lerp(float3(node_557,node_557,node_557),_ShadowPTexture_var.rgb,_ShadowPTexture_var.a),float3(node_3933,node_3933,node_3933),node_8311)*lerp(0.54,1.65,_MainTextureColorShadow)),_ShadowIntensity),_ShadowPTextureIntensity),0.65)*2.86))*lerp( lerp(node_2918,float3(node_1302,node_1302,node_1302),node_8311), node_2918, _ShowAOonLight ))+(lerp(float3(node_8890,node_8890,node_8890),lerp(float3(_SoftGloss_var,_SoftGloss_var,_SoftGloss_var),(_SoftGloss_var*_GlossColor.rgb),2.22),_GlossMask_var.rgb)*lerp((node_8388_if_leA*node_2583)+(node_8388_if_leB*_GlossIntensity),_GlossIntensity,node_8388_if_leA*node_8388_if_leB))+lerp(node_137,float3(node_2761,node_2761,node_2761),_FresnelVisibleOnDarkAmbientLight))*_LightColor0.rgb),node_5038)),dot(saturate(min(((((node_3766*(lerp(float3(node_8466,node_8466,node_8466),lerp(lerp((node_6054*_ShadowColor.rgb),lerp(float3(node_6126,node_6126,node_6126),saturate((1.0-((1.0-0.44)/_Texture_var.rgb))),node_6054),_MainTextureColorShadow),lerp(float3(node_6334,node_6334,node_6334),(lerp(lerp(float3(node_557,node_557,node_557),_ShadowPTexture_var.rgb,_ShadowPTexture_var.a),float3(node_3933,node_3933,node_3933),node_8311)*lerp(0.54,1.65,_MainTextureColorShadow)),_ShadowIntensity),_ShadowPTextureIntensity),0.65)*2.86))*lerp( lerp(node_2918,float3(node_1302,node_1302,node_1302),node_8311), node_2918, _ShowAOonLight ))+(lerp(float3(node_8890,node_8890,node_8890),lerp(float3(_SoftGloss_var,_SoftGloss_var,_SoftGloss_var),(_SoftGloss_var*_GlossColor.rgb),2.22),_GlossMask_var.rgb)*lerp((node_8388_if_leA*node_2583)+(node_8388_if_leB*_GlossIntensity),_GlossIntensity,node_8388_if_leA*node_8388_if_leB))+lerp(node_137,float3(node_2761,node_2761,node_2761),_FresnelVisibleOnDarkAmbientLight))*_LightColor0.rgb),node_5038)),float3(0.3,0.59,0.11)),node_3161);
