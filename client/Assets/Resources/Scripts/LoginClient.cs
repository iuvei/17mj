...
public class LoginClient : MonoBehaviour {
    ...
    public class RequestState
    {
        ...
        public MJApi.RequestCallBack _callback;
	...
	public void SendRequest(string url, string auth, string method, string pdata, MJApi.RequestCallBack callback)
	{
		StartCoroutine (SendRequestCor(url, auth, method, pdata, callback));
	}

	public IEnumerator SendRequestCor(string url, string auth, string method, string pdata, MJApi.RequestCallBack callback)
	{
